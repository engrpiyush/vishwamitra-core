...
class NotebookTemplateRepository(private val db: Firestore) {
    ...
    private fun NotebookTemplate.toMap(): Map<String, Any?> =
        mapOf(
            ...
            "systemRules" to systemRules,
            "systemRulesSourceVersion" to systemRulesSourceVersion,
            "systemRulesPromptHash" to systemRulesPromptHash,
            "systemRulesModel" to systemRulesModel,
            "version" to version,
    ...
    private fun DocumentSnapshot.toTemplate(): NotebookTemplate {
        ...
        return NotebookTemplate(
            ...
            systemRules = getString("systemRules") ?: "",
            systemRulesSourceVersion = getLong("systemRulesSourceVersion")?.toInt() ?: 0,
            systemRulesPromptHash = getString("systemRulesPromptHash") ?: "",
            systemRulesModel = getString("systemRulesModel"),
