...
class Stage3RunRepository(private val db: Firestore) {
    ...
    private fun Stage3Run.toMap(): Map<String, Any?> =
        mapOf(
            ...
            "cursors" to cursors,
            "gkRunRequestId" to gkRunRequestId,
            "gkTriggeredAt" to gkTriggeredAt.toTimestamp(),
            "gkPublishState" to gkPublishState,
            "gkPublishError" to gkPublishError,
    ...
    private fun DocumentSnapshot.toStage3Run(): Stage3Run =
        Stage3Run(
            ...
            gkTriggeredAt = instant("gkTriggeredAt"),
            gkPublishState = getString("gkPublishState"),
            gkPublishError = getString("gkPublishError"),
