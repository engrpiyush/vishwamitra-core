 ...
 * kept alive as permanent (301) redirects for shared links and search engines. The old
 * `index.html` URL is intentionally not redirected — it now serves the chooser.
 */
@Controller
class UserGuideController {
    ...
    fun documents(): RedirectView = movedTo("/user-guide/individuals/career-advocate/documents.html")

    @GetMapping("/user-guide/interviews.html")
    fun interviews(): RedirectView = movedTo("/user-guide/individuals/career-advocate/interviews.html")
